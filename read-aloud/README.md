...
This repo now also includes a standalone browser web app at [webapp/index.html](webapp/index.html).
...
The standalone app is designed to preserve provider-based voice support where a normal web app can do so safely:

- Native browser / Web Speech voices
- Experimental Google Translate proxy voices
- OpenAI speech API
...
These extension-only features are not portable as-is to the standalone app:

- Read Aloud hosted premium voices
- Extension popup / background / offscreen architecture
- Content-script webpage extraction
- Context-menu reading flows
- Use My Phone, Piper, and Supertonic integrations

The standalone app now includes an experimental local Google Translate proxy for testing, but it remains unofficial and may break at any time.
